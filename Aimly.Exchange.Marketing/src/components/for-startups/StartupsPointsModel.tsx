...
const StartupsPointsModel: PointsModel = {
  why: 'Why Aimly?',
  title: 'A better way to get started',
  description: 'Only Aimly provides all startup expertise requirements via a mentored process.',
  points: [
    {
      title: 'Mentorship',
      icon: SupportIcon,
...
export default StartupsPointsModel;
