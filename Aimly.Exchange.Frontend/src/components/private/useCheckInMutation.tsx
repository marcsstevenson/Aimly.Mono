...
import { AuthProfileInput, checkInMutation$data } from '__generated__/checkInMutation.graphql';
import { checkInMutation as def } from 'checkInMutation';

function getOptimisticResponse(input: AuthProfileInput): checkInMutation$data {
  return {
    checkIn: '',
  };
}
