...
const DashBoardUpdates = () => {
  const updates = useMemo<update[]>(() => {
    return [
      {
        title: 'Welcome to the Quality Life Exchange',
        image:
                  ...
                  <div className="relative sm:overflow-hidden sm:rounded-2xl">
                    ...
                    <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                      <h1 className="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                        ...
                        <span className="block text-secondary-100">Quality Life Exchange</span>
                      </h1>
                      <div className="mx-auto mt-10 max-w-sm sm:flex sm:max-w-none sm:justify-center">
                        <div className="space-y-4 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5 sm:space-y-0">
                          ...
                          {/* <NavLink
                            ...
                            className="flex items-center justify-center rounded-md border border-transparent bg-primary-400 px-4 py-3 text-base font-medium text-primary-900 shadow-sm hover:bg-primary-500 sm:px-8"
                          >
                            Become a client
                          </NavLink> */}
                          <NavLink
