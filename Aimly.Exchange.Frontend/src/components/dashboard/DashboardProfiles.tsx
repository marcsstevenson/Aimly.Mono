...
import MarketGridResult from '../market/MarketGridResult';
import { AssociatedProfilesSet } from '../market/view/ViewProfileInterfaces';
  ...
  return (
    <>
      ...
      <div className="col-span-8 lg:col-span-4">
        <ul className="grid grid-cols-1 gap-6 p-5 dark:bg-gray-800 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 2xl:grid-cols-3">
          {profiles &&
