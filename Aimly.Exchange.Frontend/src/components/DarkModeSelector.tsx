        ...
        <Menu as="div" className="ml-3 relative">
          ...
          >
            <Menu.Items className="absolute z-50 top-full right-0 bg-white rounded-lg ring-1 ring-gray-900/10 shadow-lg overflow-hidden w-36 py-1 text-sm text-gray-700 font-semibold dark:bg-gray-800 dark:ring-0 dark:highlight-white/5 dark:text-gray-300 mt-6">
                  ...
                  <button onClick={() => setLightMode()} className="inline-flex w-full px-2 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-indigo-50 dark:hover:bg-gray-600 focus:outline-none">
                    <span>
                      ...
                      >
                        <path
                          d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"
                          className={`${ theme === ThemeOption.light ? "fill-indigo-400/20 stroke-indigo-500" : "stroke-gray-400 dark:stroke-gray-500" } `}
                        ></path>
                        <path
                          d="M12 4v1M17.66 6.344l-.828.828M20.005 12.004h-1M17.66 17.664l-.828-.828M12 20.01V19M6.34 17.664l.835-.836M3.995 12.004h1.01M6 6l.835.836"
                          className={`${ theme === ThemeOption.light ? "stroke-indigo-500" : "stroke-gray-400 dark:stroke-gray-500" } `}
                        ></path>
                      </svg>
                    </span>
                    <span>Light</span>
              ...
              <Menu.Item>
                {({ active }) => (
                  <button onClick={() => setDarkMode()} className="inline-flex w-full px-2 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-indigo-50 dark:hover:bg-gray-600 focus:outline-none">
                    <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6 mr-2">
                      ...
                      <path
                        d="m17.715 15.15.95.316a1 1 0 0 0-1.445-1.185l.495.869ZM9 6.035l.846.534a1 1 0 0 0-1.14-1.49L9 6.035Zm8.221 8.246a5.47 5.47 0 0 1-2.72.718v2a7.47 7.47 0 0 0 3.71-.98l-.99-1.738Zm-2.72.718A5.5 5.5 0 0 1 9 9.5H7a7.5 7.5 0 0 0 7.5 7.5v-2ZM9 9.5c0-1.079.31-2.082.845-2.93L8.153 5.5A7.47 7.47 0 0 0 7 9.5h2Zm-4 3.368C5 10.089 6.815 7.75 9.292 6.99L8.706 5.08C5.397 6.094 3 9.201 3 12.867h2Zm6.042 6.136C7.718 19.003 5 16.268 5 12.867H3c0 4.48 3.588 8.136 8.042 8.136v-2Zm5.725-4.17c-.81 2.433-3.074 4.17-5.725 4.17v2c3.552 0 6.553-2.327 7.622-5.537l-1.897-.632Z"
                        className={`${ theme === ThemeOption.dark ? "stroke-indigo-500 fill-indigo-400/20" : "fill-gray-400 dark:fill-gray-500" } `}
                      ></path>
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M17 3a1 1 0 0 1 1 1 2 2 0 0 0 2 2 1 1 0 1 1 0 2 2 2 0 0 0-2 2 1 1 0 1 1-2 0 2 2 0 0 0-2-2 1 1 0 1 1 0-2 2 2 0 0 0 2-2 1 1 0 0 1 1-1Z"
                        className={`${ theme === ThemeOption.dark ? "stroke-indigo-500" : "fill-gray-400 dark:fill-gray-500" } `}
                      ></path>
                    </svg>
                    Dark
                  </button>
              ...
              <Menu.Item>
                {({ active }) => (
                  <button onClick={() => setSystemMode()} className="inline-flex w-full px-2 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-indigo-50 dark:hover:bg-gray-600 focus:outline-none">
                    <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6 mr-2">
                      <path
                        d="M4 6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6Z"
                        strokeWidth="2"
                        strokeLinejoin="round"
                        className={`${ theme === ThemeOption.system ? "stroke-indigo-500 fill-indigo-400/20" : "stroke-gray-400 dark:stroke-gray-500" } `}
                      ></path>
                      <path
                        ...
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        className={`${ theme === ThemeOption.system ? "stroke-indigo-500" : "stroke-gray-400 dark:stroke-gray-500" } `}
                      ></path>
                    </svg>
                    System
                  </button>
