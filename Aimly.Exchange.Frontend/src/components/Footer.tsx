...
const Footer = () => {
  ...
  // Take the social links from the current tenant and mesh them with the default link options
  navigation.social.forEach((social) => {
    const match = currentTenant?.socialLinks?.find((s) => s.type === social.name);

    if (match) {
      social.href = match.href;
    }
  });
